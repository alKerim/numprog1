...
public class Plotter extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        /* draw x-axis caption */
        graphics.drawString((Float.valueOf(minX)).toString(), PADDING + 2, height
                - PADDING + 12);
        graphics.drawString(
                (Float.valueOf((float) Math.pow(10.0d, 0.25f * Math.log10(maxX) + 0.75f
                        * Math.log10(minX)))).toString(), PADDING + 0.25f
                        * (width - 2 * PADDING) + 2, height - PADDING + 12);
        graphics.drawString(
                (Float.valueOf((float) Math.pow(10.0d,
                        0.5f * (Math.log10(maxX) + Math.log10(minX)))))
                        .toString(), 0.5f * width + 2, height - PADDING + 12);
        graphics.drawString(
                (Float.valueOf((float) Math.pow(10.0d, 0.75f * Math.log10(maxX) + 0.25f
                        * Math.log10(minX)))).toString(), PADDING + 0.75f
                        * (width - 2 * PADDING) + 2, height - PADDING + 12);
        graphics.drawString((Float.valueOf(maxX)).toString(), width - PADDING + 2,
                height - PADDING + 12);
        ...
        /* draw y-axis caption */
        graphics.drawString(( Float.valueOf(minY)).toString(), PADDING + 2,
                (height - 2 * PADDING) + PADDING - 2);
        graphics.drawString(
                ( Float.valueOf((float) Math.pow(10.0d, 0.25f * Math.log10(maxY) + 0.75f
        ...
        graphics.drawString(
                ( Float.valueOf((float) Math.pow(10.0d, 0.75f * Math.log10(maxY) + 0.25f
                        * Math.log10(minY)))).toString(), PADDING + 2, height
                        - (PADDING + 0.75f * (height - 2 * PADDING)) - 2);
        graphics.drawString((Float.valueOf(maxY)).toString(), PADDING + 2,
                PADDING - 2);
